...
class LocationDetectWidget extends StatefulWidget {
  ...
  static String routeName = 'LocationDetect';
  static String routePath = '/locationDetect';
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Flexible(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'yvc7yjmd' /* Find culinary experiences near... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .titleLarge
                                                .override(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Flexible(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '8jzk2pr6' /* Locate cooking classes, tastin... */,
                                            ),
                                  ...
                                  children: [
                                    Expanded(
                                      child: FFButtonWidget(
                                        ...
                                        text:
                                            FFLocalizations.of(context).getText(
                                          'a3ezcihm' /* Detect Nearest Location */,
                                        ),
                                                  ...
                                                  Flexible(
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '5lsa42hm' /*  Colombian Cuisine Workshop  */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                  ...
                                                  Flexible(
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'iysr7r4n' /* Available until 10:45 PM */,
                                                      ),
                                                      textAlign:
                                                          TextAlign.center,
                                                      style:
