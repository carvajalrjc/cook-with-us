...
class DetailTwoWidget extends StatefulWidget {
  ...
  static String routeName = 'DetailTwo';
  static String routePath = '/detailTwo';
                                        ...
                                        ClipRRect(
                                          ...
                                          child: CachedNetworkImage(
                                            ...
                                            fadeOutDuration:
                                                Duration(milliseconds: 500),
                                            imageUrl:
                                                'https://images.unsplash.com/photo-1597012523223-3b2300183816?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyMXx8c2F1Y2V8ZW58MHx8fHwxNzQwOTM2MDQ3fDA&ixlib=rb-4.0.3&q=80&w=1080',
                                            width: double.infinity,
                                            height: 280.0,
                                            fit: BoxFit.cover,
                                          ),
                                              ...
                                              children: [
                                                Flexible(
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'j3p2m3nr' /* Authentic Tacos & Salsas Works... */,
                                                    ),
                                                      ...
                                                      children: [
                                                        TextSpan(
                                                          text: FFLocalizations
                                                                  .of(context)
                                                              .getText(
                                                            'pmpuc2wi' /* Discover the authentic taste o... */,
                                                          ),
                                                      ...
                                                      children: [
                                                        TextSpan(
                                                          text: FFLocalizations
                                                                  .of(context)
                                                              .getText(
                                                            'b6kmz9rt' /* 📢 "Amazing experience! Now I ... */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .labelMedium
