                              ...
                              Flexible(
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'i78vidqg' /* List of Booked Classes */,
                                  ),
                                                            ...
                                                            children: [
                                                              Container(
                                                                ...
                                                                child:
                                                                  ...
                                                                  child: Image
                                                                      .network(
                                                                    'https://images.unsplash.com/photo-1501514799070-290ae1c889fe?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxpbnRlcm5hdGlvbmFsfGVufDB8fHx8MTc0MDk0Mjk0M3ww&ixlib=rb-4.0.3&q=80&w=1080',
                                                                    width:
                                                                        300.0,
                                                                    height:
                                                                        200.0,
                                                                      ...
                                                                      children: [
                                                                        Flexible(
                                                                          child:
                                                                              Text(
                                                                            FFLocalizations.of(context).getText(
                                                                              'q1zvqh2a' /* International Cuisine Workshop */,
                                                                            ),
                                                                      ...
                                                                      children: [
                                                                        Flexible(
                                                                          child:
                                                                              Text(
                                                                            FFLocalizations.of(context).getText(
                                                                              'hmdvxxgk' /* Japanese Sushi Masterclass */,
                                                                            ),
                                                                            style: FlutterFlowTheme.of(context).titleMedium.override(
                                                                                  font: GoogleFonts.plusJakartaSans(
                                                                                    fontWeight: FlutterFlowTheme.of(context).titleMedium.fontWeight,
