                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText: FFLocalizations.of(context)
                                              .getText(
                                            '62bdi6xm' /* Find the culinary experience y... */,
                                          ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    ...
                                    text: FFLocalizations.of(context).getText(
                                      'r63ieljx' /* Wine Tastings & Pairings */,
                                    ),
                                    icon: Icon(
                                      Icons.wine_bar,
                                      color: FlutterFlowTheme.of(context)
                                  ...
                                  FFButtonWidget(
                                    ...
                                    text: FFLocalizations.of(context).getText(
                                      'wsvud8bm' /* International Cuisine */,
                                    ),
                                    icon: Icon(
                                      Icons.soup_kitchen,
                                      color:
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'st0s5x2f' /* Authentic Tacos & Salsas Works... */,
                                                            ),
                                                            maxLines: 2,
