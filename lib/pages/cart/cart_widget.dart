                                                          ...
                                                          borderRadius:
                                                              BorderRadius
                                                                  .circular(
                                                                      12.0),
                                                          child: Image.network(
                                                            'https://images.unsplash.com/photo-1607083206968-13611e3d76db?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxkaXNjb3VudHxlbnwwfHx8fDE3NDA5Mzg4MzV8MA&ixlib=rb-4.0.3&q=80&w=1080',
                                                            width:
                                                                double.infinity,
                                                            height:
                                                                double.infinity,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            text:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                TextSpan(
                                                                                  text: FFLocalizations.of(context).getText(
                                                                                    'htyankjb' /*   off on your first class */,
                                                                                  ),
                                                                                  style: FlutterFlowTheme.of(context).titleSmall.override(
                                                                                        font: GoogleFonts.plusJakartaSans(
                                                                                          fontWeight: FlutterFlowTheme.of(context).titleSmall.fontWeight,
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'zy9wy916' /* List of Booked Classes */,
                                                  ),
                                                          ...
                                                          Flexible(
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'epb53p4l' /* Japanese Sushi Masterclass */,
                                                              ),
                                                              maxLines: 2,
                                                          ...
                                                          Flexible(
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'wjruofus' /* Authentic Tacos & Salsas Works... */,
                                                              ),
                                                              maxLines: 2,
                                                              style: FlutterFlowTheme
                                                                      .of(context)
