...
class _FavoriteItemWidgetState extends State<FavoriteItemWidget> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () async {
        context.pushNamed(DetailWidget.routeName);
      },
      child: Container(
          ...
          children: [
            Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(20.0),
                child: Image.network(
                  'https://images.unsplash.com/photo-1547595628-c61a29f496f0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHx3aW5lfGVufDB8fHx8MTc0MDk0MDc2N3ww&ixlib=rb-4.0.3&q=80&w=1080',
                  fit: BoxFit.cover,
                ),
              ),
            ),
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '10hcqqzp' /* Cata y Maridaje de Vinos  */,
                            ),
                            maxLines: 2,
