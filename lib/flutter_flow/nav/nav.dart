...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: LocationDetectWidget.routeName,
          path: LocationDetectWidget.routePath,
          builder: (context, params) => LocationDetectWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: DetailTwoWidget.routeName,
          path: DetailTwoWidget.routePath,
